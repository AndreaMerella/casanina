      ...
      <div style={{ display: "flex", width: "100%", height: "100%" }}>
        ...
        <div style={{ width: 460, height: 630, background: "#1e1c1a", display: "flex", flexDirection: "column", overflow: "hidden" }}>
          ...
          <div style={{ flex: 1, background: PINK, display: "flex", flexDirection: "column", padding: "0 28px" }}>
            ...
            {/* String course */}
            <div style={{ width: 404, height: 4, background: "#c8887a", opacity: 0.6, marginTop: 20 }} />
            ...
            <div style={{ display: "flex", gap: 20, marginTop: 14 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column" }}>
                ...
                {/* Door */}
                <div style={{ width: 84, height: 188, background: SHUTTER, display: "flex", flexDirection: "column", alignItems: "center", padding: "10px 8px", gap: 6 }}>
                  <div style={{ width: 66, height: 52, background: "#265033", opacity: 0.4, borderRadius: 2 }} />
                  {/* Wreath — ring using two nested divs */}
                  <div style={{ width: 38, height: 38, borderRadius: 19, background: "#1a3822", display: "flex", alignItems: "center", justifyContent: "center" }}>
                    <div style={{ width: 22, height: 22, borderRadius: 11, background: SHUTTER }} />
                  </div>
                  <div style={{ width: 66, height: 52, background: "#265033", opacity: 0.4, borderRadius: 2 }} />
